...
contextBridge.exposeInMainWorld("api", {
  ...
  analyseBinary: (sessionId: string, binaryIndex: number, cpuType?: number, cpuSubtype?: number) =>
  ...
  searchAllBinaries: (sessionId: string, query: string, tab: string, isRegex?: boolean, caseSensitive?: boolean) =>
  ...
  onProgress: (cb: (data: { sessionId: string; phase: string; percent: number; message: string }) => void) => {
