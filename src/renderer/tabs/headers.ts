...
const MH_FLAGS: Record<number, string> = {
	...
	256: "MH_FORCE_FLAT",
	512: "MH_NOMULTIDEFS",
	1024: "MH_NOFIXPREBINDING",
	2048: "MH_PREBINDABLE",
	4096: "MH_ALLMODSBOUND",
	8192: "MH_SUBSECTIONS_VIA_SYMBOLS",
	16384: "MH_CANONICAL",
	32768: "MH_WEAK_DEFINES",
	65536: "MH_BINDS_TO_WEAK",
	131072: "MH_ALLOW_STACK_EXECUTION",
	262144: "MH_ROOT_SAFE",
	524288: "MH_SETUID_SAFE",
	1048576: "MH_NO_REEXPORTED_DYLIBS",
	2097152: "MH_PIE",
	4194304: "MH_DEAD_STRIPPABLE_DYLIB",
	8388608: "MH_HAS_TLV_DESCRIPTORS",
	16777216: "MH_NO_HEAP_EXECUTION",
	33554432: "MH_APP_EXTENSION_SAFE"
};
	...
	for (const seg of segments) {
		...
		segHeader.appendChild(
			el(
				"span",
				"hdr-seg-meta",
				`${humanSize(s.filesize)} | offset ${hexStr(s.fileoff)} | ${permStr(s.initprot)}`
			)
		);
			...
			for (const sec of s.sections) {
				...
				secRow.appendChild(
					el(
						"span",
						"hdr-sec-detail",
						`${humanSize(sizeVal)} | offset ${hexStr(sec.offset)}`
					)
				);
...
export function renderHeaders(container: HTMLElement, data: HeadersData | null): void {
	...
	summaryBody.appendChild(
		buildSummaryRow("CPU Subtype", decodeCpuSubtype(hdr.cputype, hdr.cpusubtype))
	);
