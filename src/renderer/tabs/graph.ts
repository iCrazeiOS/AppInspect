...
import type { LibraryGraphData, LibraryGraphEdge, LibraryGraphNode } from "../../shared/types";
...
function buildLegend(data: LibraryGraphData, onToggle: () => void): LegendResult {
	...
	const items: [string, string, () => boolean, string[]][] = [
		[
			"gr-legend-dot--binary-main",
			"Main Binary",
			() => hasType.has("binary:main"),
			["binary:main"]
		],
		[
			"gr-legend-dot--binary-fw",
			"Frameworks",
			() => hasType.has("binary:framework") || hasType.has("binary:extension"),
			["binary:framework", "binary:extension"]
		],
		[
			"gr-legend-dot--binary-tweak",
			"Tweaks",
			() => hasType.has("binary:tweak"),
			["binary:tweak"]
		],
		[
			"gr-legend-dot--framework",
			"System Frameworks",
			() => hasType.has("library:framework"),
			["library:framework"]
		],
		[
			"gr-legend-dot--system",
			"System Libraries",
			() => hasType.has("library:system"),
			["library:system"]
		],
		[
			"gr-legend-dot--swift",
			"Swift Libraries",
			() => hasType.has("library:swift"),
			["library:swift"]
		],
		[
			"gr-legend-dot--embedded",
			"Embedded Libraries",
			() => hasType.has("library:embedded"),
			["library:embedded"]
		],
...
export function mountGraphView(container: HTMLElement, sessionId: string): () => void {
	container.innerHTML = "";
